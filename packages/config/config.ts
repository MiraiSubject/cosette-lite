...
/**
    * @description This function is used to check if the user is eligible for the verified role(s) specified in your config.
    ...
    * 
*/
export function isUserEligible(userData: { join_date: string }): boolean {
